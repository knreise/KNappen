...
public class VideoPlayer extends CordovaPlugin {
    ...
    private static final String VIMEO = "vimeo.com";
    private static final String YOU_TUBE_PACKAGE_NAME = "com.google.android.youtube";
    private static final String VIMEO_PACKAGE_NAME = "com.vimeo.android.videoapp";
    private static final String ASSETS = "file:///android_asset/";

    @Override
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
    	
    	Log.d("VideoPlayer", "Execute, action: " + action);
    ...
    private void playVideo(String url) throws IOException {
    	...
    	Log.d("playVideo", "Inside playVideo, url: " + url);
        ...
        if (url.contains(YOU_TUBE)) {
            ...
            intent = getLaunchAppIntent(YOU_TUBE_PACKAGE_NAME, uri);
        /*} else if (url.contains(VIMEO)) {
        	//Uri.parse("http://player.vimeo.com/video/"+ADD_VIDEO_ID_HERE)
            intent = getLaunchAppIntent(VIMEO_PACKAGE_NAME, uri);*/
            ...
            // Display video player
        	Log.d("Display video player", "Trying to display android video player");
            intent = new Intent(Intent.ACTION_VIEW);
            intent.setData(uri);
            //intent.setDataAndType(uri, "video/*");
        }
    ...
    private Intent getLaunchAppIntent(String name, Uri uri) {
