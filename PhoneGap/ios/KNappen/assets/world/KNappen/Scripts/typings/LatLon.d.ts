interface LatLon {
    ...
    */
     ...
     * @returns {LatLon} Midpoint between this point and the supplied point
     */
    rhumbMidpointTo(poin: LatLon): LatLon;
    /**
     ...
     */
    lat(format: string, dp: number): string;
    /**
     ...
     * @returns {Number|String} Numeric degrees if no format specified, otherwise deg/min/sec
     */
    lon(format: string, dp: number): string;
    /**
...
declare var LatLon: {
   ...
   */
   ...
   /**
     ...
     */
   new (lat: number, lon: number): LatLon;
   /**
     * Creates a point on the earth's surface at the supplied latitude / longitude
     *
     * @constructor
     ...
     */
    new (lat: number, lon: number, rad: number): LatLon;
}