...
(function (System) {
    ...
    (function (Providers) {
        var MapCacheProvider = (function () {
            function MapCacheProvider() {
            }
            MapCacheProvider.prototype.addCacheToMap = function (cachingType, map) {
        ...
        Providers.MapCacheProvider = MapCacheProvider;
            ...
            cache: function (obj) {
                ...
                try  {
                    ...
                    if (canvasContext) {
                        ...
                        mapStorageProvider.set(this.cachingType, "olCache_" + url, canvasContext.canvas.toDataURL(this.imageFormat));
...
//@ sourceMappingURL=MapCacheProvider.js.map
