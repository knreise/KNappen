...
(function (App) {
    ...
    */
    (function (SearchProviders) {
        var DataSourceDigitalarkivetProperty = (function () {
            /**
            ...
            */
            function DataSourceDigitalarkivetProperty() {
            }
            /**
            search
            ...
            @public
            */
            DataSourceDigitalarkivetProperty.prototype.search = function (searchCriteria, successCallback, errorCallback) {
            ...
            DataSourceDigitalarkivetProperty.prototype.searchCriteriaToDigitalArkivetUrl = function (searchCriteria) {
                //return config.webProxy + encodeURIComponent("http://api.digitalarkivet.arkivverket.no/v1/census/1910/search_property_geo?"
                return "http://api.digitalarkivet.arkivverket.no/v1/census/1910/search_property_geo?" + "latitude=" + searchCriteria.pos().lat() + "&longitude=" + searchCriteria.pos().lon() + "&presicion=" + (searchCriteria.radius() * 1000) + "&limit=" + searchCriteria.rows() + "&page=" + searchCriteria.pageNumber();
            };
...
//@ sourceMappingURL=DataSourceDigitalarkivetProperty.js.map
