...
(function (App) {
    ...
    */
    (function (SearchProviders) {
        ...
        var DataSourceNorvegiana = (function () {
            /**
            ...
            */
            ...
            @public
            */
            DataSourceNorvegiana.prototype.search = function (searchCriteria, successCallback, errorCallback) {
                ...
                $.getJSON(searchUrl, function (data) {
                    ...
                    $.each(items, function (objid, object) {
                        ...
                        if (p.abm_category) {
                            $.each(p.abm_category, function (k, v) {
                        ...
                        var mediaType = null;
                        $.each(p.europeana_type, function (k, v) {
            ...
            ////}
            DataSourceNorvegiana.prototype.searchCriteriaNorgevianaToUrl = function (searchCriteria) {
                // qf filter params
                var qfParams = '';
                ...
                if (searchCriteria.radius() != null && searchCriteria.radius() != 0 && searchCriteria.pos() != null && searchCriteria.pos().lat() != null && searchCriteria.pos().lon() != null) {
                    posStr = '&pt=' + searchCriteria.pos().lat() + ',' + searchCriteria.pos().lon() + '&d=' + searchCriteria.radius();
                }
                ...
                return config.norvegianaURL + encodeURIComponent(searchQuery) + posStr + '&rows=' + searchCriteria.rows() + '&start=' + ((searchCriteria.rows() * (searchCriteria.pageNumber() - 1)) + 1) + '&format=json' + sorting + qfParams;
            };
...
//@ sourceMappingURL=DataSourceNorvegiana.js.map
